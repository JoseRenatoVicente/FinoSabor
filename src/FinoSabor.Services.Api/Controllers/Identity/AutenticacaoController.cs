...
namespace FinoSabor.Services.Api.Controllers.Identity
{
    ...
    public class AutenticacaoController : MainController
    {
        ...
        public AutenticacaoController(INotificador notificador, IAspNetUser user,
        ...
        public async Task<ActionResult> Registrar(UsuarioRegistro usuarioRegistro)
        {
            ...
            if (result.Succeeded)
            {
                var usertoRole = await UserManager.FindByNameAsync(usuarioRegistro.Email);
                await UserManager.AddToRoleAsync(usertoRole, "usuario");
                //TODO: arrumar
